...
require (
	...
	github.com/jlambert68/FenixTestInstructionsAdminShared v0.0.0-20241023123956-0b5ca83de45c
)
...
require (
	...
	github.com/jlambert68/FenixSyncShared v0.0.0-20240911064419-da3d922610cb // indirect
